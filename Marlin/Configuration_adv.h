 ...
 */
  ...
  // #define THERMAL_PROTECTION_BED_PERIOD        20 // Seconds // Defined in Configuration_tenlog.h
  #define THERMAL_PROTECTION_BED_HYSTERESIS     2 // Degrees Celsius

  /**
   * As described above, except for the bed (M140/M190/M303).
   */
  // #define WATCH_BED_TEMP_PERIOD                60 // Seconds // Defined in Configuration_tenlog.h
...
//#define Z_STEPPER_AUTO_ALIGN
  ...
  //#define Z_STEPPER_ALIGN_XY { {  15, 280 }, { 100,  15 }, { 280, 280 } }
 ...
 */
  ...
  #define MESH_MIN_X LUX_MESH_MIN_X
  #define MESH_MIN_Y LUX_MESH_MIN_Y
  #define MESH_MAX_X LUX_MESH_MAX_X
  #define MESH_MAX_Y LUX_MESH_MAX_Y
#endif
