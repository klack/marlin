#define SHORT_BUILD_VERSION "bugfix-2.0.x lux-0.7"
...
#else // Stock Configuration (AS OpticalY 2208)
  ...
  #define Y_MIN_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.
    ...
    #define NO_MOTION_BEFORE_HOMING
	  ...
	  #define NOZZLE_TO_PROBE_OFFSET { -25, -55, -4 }
  ...
  #endif
  #if ENABLED(BL_Touch) || ENABLED(EZabl)
	  #undef USE_ZMAX_PLUG
    ...
    #else
  		#define Z_SAFE_HOMING_X_POINT 152.5  // X point for Z homing
		  #define Z_SAFE_HOMING_Y_POINT 152.5  // Y point for Z homing
      #define BED_CENTER_AT_152_152
	  #endif
