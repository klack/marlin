...
/*
DEFAULT VALS:
LUX_DEFAULT_Y_MIN_POS = 3
LUX_DEFAULT_X_MIN_POS = -50
LUX_DEFAULT_X2_MIN_POS = 10
...
CALCS:
X_MIN_POS = LUX_DEFAULT_X_MIN_POS + LUX_EXTRUDER_X_SPACING_LEFT
X_MAX_POS = LUX_MEASURED_X_BED_SIZE - LUX_EXTRUDER_X_SPACING_RIGHT
X_BED_SIZE = LUX_MEASURED_X_BED_SIZE

Y_MIN_POS = LUX_DEFAULT_Y_MIN_POS + LUX_EXTRUDER_Y_OFFSET + LUX_ENDSTOP_Y_OFFSET
