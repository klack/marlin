...
#define Y_MIN_POS 3 //LUX_EXTRUDER_Y_OFFSET +(LUX_ENDSTOP_Y_OFFSET)
#define Y_MAX_POS 324 //LUX_MEASURED_Y_BED_SIZE +(LUX_EXTRUDER_Y_OFFSET + LUX_ENDSTOP_Y_OFFSET)
...
#define Y_BED_SIZE 321 //LUX_MEASURED_Y_BED_SIZE -(Y_MIN_POS)
