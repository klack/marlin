...
#if ENABLED(TitanExtruder)
  #define LUX_EXTRUDER_X_SPACING_RIGHT 3
  #define LUX_EXTRUDER_X_SPACING_LEFT 6
  #define LUX_EXTRUDER_Y_OFFSET 5
  #undef X2_MIN_POS
  #undef X_MAX_POS
  #undef X2_MAX_POS
...
/*
INPUT PARAMETERS FROM IF LOGIC:
LUX_MEASURED_X_BED_SIZE
LUX_MEASURED_Y_BED_SIZE
LUX_EXTRUDER_X_SPACING_LEFT
LUX_EXTRUDER_X_SPACING_RIGHT
LUX_EXTRUDER_Y_OFFSET
...
#define X_MIN_POS LUX_DEFAULT_X_MIN_POS + LUX_EXTRUDER_X_SPACING_LEFT
#define X_MAX_POS LUX_MEASURED_X_BED_SIZE - LUX_EXTRUDER_X_SPACING_RIGHT

#define Y_MIN_POS LUX_DEFAULT_Y_MIN_POS + LUX_EXTRUDER_Y_OFFSET + LUX_ENDSTOP_Y_OFFSET
#define Y_MAX_POS LUX_MEASURED_Y_BED_SIZE + LUX_EXTRUDER_Y_OFFSET + LUX_ENDSTOP_Y_OFFSET
#define Y_BED_SIZE LUX_MEASURED_Y_BED_SIZE - Y_MIN_POS

#define X2_MIN_POS LUX_DEFAULT_X2_MIN_POS + LUX_EXTRUDER_X_SPACING_LEFT
#define X2_MAX_POS LUX_MEASURED_X_BED_SIZE + 44
