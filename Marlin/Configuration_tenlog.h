...
#define Y_MIN_POS //Always 0
#define Y_MAX_POS 328 //LUX_MEASURED_Y_BED_SIZE + (LUX_ENDSTOP_Y_OFFSET) + (LUX_EXTRUDER_Y_OFFSET)
...
#define LUX_MESH_MIN_Y LUX_BED_CLIP_SIZE -3 - LUX_EXTRUDER_Y_OFFSET //TRUE YMIN POS IS 5  3 default + 2 FOR Titan
