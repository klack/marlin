...
void GcodeSuite::G34() {
  ...
  do { // break out on error
    ...
    if (homing_needed_error(_BV(X_AXIS) | _BV(Y_AXIS))) process_subcommands_now_P(PSTR("G28XY"));
    if (homing_needed_error(_BV(Z_AXIS))) process_subcommands_now_P(PSTR("G28Z"));
